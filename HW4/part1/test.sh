...
parallel-scp -h ../host.txt -r ~/Parallel_Programming/HW4/part1/pi_block_linear ~/pi_block_linear >/dev/null
echo "<<stu>>"
...
parallel-scp -h ../host.txt -r ~/Parallel_Programming/HW4/part1/pi_block_tree ~/pi_block_tree >/dev/null
echo "<<stu>>"
...
parallel-scp -h ../host.txt -r ~/Parallel_Programming/HW4/part1/pi_nonblock_linear ~/pi_nonblock_linear >/dev/null
echo "<<stu>>"
...
parallel-scp -h ../host.txt -r ~/Parallel_Programming/HW4/part1/pi_gather ~/pi_gather >/dev/null
echo "<<stu>>"
...
parallel-scp -h ../host.txt -r ~/Parallel_Programming/HW4/part1/pi_reduce ~/pi_reduce >/dev/null
echo "<<stu>>"
...
parallel-scp -h ../host.txt -r ~/Parallel_Programming/HW4/part1/pi_one_side ~/pi_one_side >/dev/null
echo "<<stu>>"
